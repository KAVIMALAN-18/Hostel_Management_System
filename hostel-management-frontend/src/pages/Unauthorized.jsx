        ...
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
            <div className="max-w-md w-full text-center">
                ...
                <Card className="border-none shadow-2xl shadow-slate-200/50 p-8">
                    <h1 className="text-2xl font-bold text-slate-800 mb-4 uppercase tracking-tight italic">Access Restricted</h1>
                    ...
                    <Link to="/">
                        <Button className="w-full py-3 text-xs tracking-wide font-bold uppercase italic">
                            Back to Safe Zone
                        </Button>
                    </Link>
                </Card>

                <p className="mt-10 text-xs text-slate-400 font-bold uppercase tracking-wide opacity-50">
